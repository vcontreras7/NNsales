...
**ASSIGNMENT:**    
  ...
  I obtained a target price of $9000. 
  ...
  I had 5 layers all including age, miles, debt, income, and sales. 
  
  4. Does it help to use 80/20 (or any other) split for training/test sets?  
  Yes, i used the .75 2/3 spit for the training and t test.  
  
  5. Recommend an advetising approach based on your findings. 
  I should keep them around age of 25 within 30 miles for the best findings. 
...
x = filter(cars, age < 25 & income>4000 & debt < 10000 & miles > 30)
